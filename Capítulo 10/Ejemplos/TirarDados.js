...
function iniciar()
{
    var botton = document.getElementById("botonTirar");
    botton.addEventListener("click", tirarDados, false);
...
function actualizarTablaFrecuencias()
{
    ...
    {
        resultados += "<tr><td>" + i + "</td><td>" + frecuencia[i] + "</td><td>" + formatoPorciento(frecuencia[i] / totalDados) + "</td></tr>";
    } // fin de for
