...
function botonPresionado()
{
    ...
    document.getElementById("resultados").innerHTML = "<p>La primera ocurrencia se encuentra en el &iacute;ndice " + letras.indexOf(campoEntrada.value) + "</p>" + "<p>La &uacute;ltima ocurrencia se encuentra en el &iacute;ndice " + letras.lastIndexOf(campoEntrada.value) + "</p>" + "<p>La primera ocurrencia del &iacute;ndice se encuentra en el &iacute;ndice " +letras.indexOf(campoEntrada.value, 12) + "</p>" + "<p>La &uacute;ltima ocurrencia del &iacute;ndice 12 se encuentra en el &iacute;ndice " + letras.lastIndexOf(campoEntrada.value, 12) + "</p>";
