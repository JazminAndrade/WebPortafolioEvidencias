...
function iniciar()
{
    ...
    // métodos get
    document.getElementById("metodosGet").innerHTML = "<p>getDate: " + actual.getDate() + "</p>" + "<p>getDay: " + actual.getDay() + "</p>" + "<p>getMonth: " + actual.getMonth() + "</p>" + "<p>getFullYear: " + actual.getFullYear() + "</p>" + "<p>getTime: " + actual.getTime() + "</p>" + "<p>getHours: " + actual.getHours() + "</p>" + "<p>getMinutes: " + actual.getMinutes() + "</p>" + "<p>getSeconds: " + actual.getSeconds() + "</p>" + "<p>getMiliseconds: " + actual.getMilliseconds() + "</p>" + "<p>getTimezoneOffset: " + actual.getTimezoneOffset() + "</p>";
